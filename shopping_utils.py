...
aldi_org_dict = {"broccoli":1.0,"carrots":1.0,"celery":2.5,"cucumber":2.5,
                 "green beans":1.0,"lettuce":1.0,"onions":2.5,"peppers":2.5,
                 "potatoes":2.5,"spinach":1.0,"tomatoes":2.5,"zucchini":2.5,
                 "apples":1.0,"bananas":1.0,"grapes":1.0,"oranges":1.0,
                 "peaches":1.0,"pineapple":1.0,"strawberries":1.0,
                 ...
                 "bread":1.5,"bagels":1.5,"buns":1.5,"hot dog buns":1.5,
                 "hamburger buns":1.5,"rolls":1.5,"chips":1.5,"crackers":1.5,
                 "goldfish":1.5,"graham crackers":1.5,"pretzels":1.5,
                 "tortilla chips":1.5,"chicken":1.9,"ground beef":1.9,
                 "pork chops":1.9,"steak":1.9,"chicken breast":1.9,"salmon":1.9,
                 ...
                 "sausage":1.9,"hot italian sausage":1.9,"turkey":3.9,"turkey breast":3.9,
                 "salami":3.9,"ham":3.9,"sliced cheese":3.9,"cheddar cheese":3.9,"swiss cheese":3.9,
                 ...
                 "tomato sauce":4.5,"pasta":4.5,"macaroni":4.5,"spaghetti":4.5,"noodles":4.5,
                 "rigatoni":4.5,"lasagna noodles":4.5,"angel hair pasta":4.5,"egg noodles":4.5,
                 "pesto":4.5,"parmesan cheese":4.9,"parmesan":4.9,"guacamole":4.9,"prosciutto":4.9,
                 "cream cheese":5.0,"buttermilk":5.0,"milk":5.0,"eggs":5.0,"yogurt":5.0,"butter":5.0,
                 "cream":5.0,"sour cream":5.0,"heavy cream":5.0,"whipping cream":5.0,
                 "half and half":5.0,"creamer":5.0,"gogurt":5.0,"yoplait":5.0,"yogurt tubes":5.0,
                 "orange juice":5.0,"almond milk":5.0,"soy milk":5.0,"chicken nuggets":5.5,
                 "chicken tenders":5.5,"chicken fingers":5.5,"frozen chicken":5.5,
                 "frozen chicken breasts":5.5,"hot dogs":5.5,"frozen pizza":5.5,"hash browns":5.5,
                 "ice cream":5.5,"frozen vegetables":5.5,"frozen corn":5.5,"frozen peas":5.5,
                 "cod fillets":5.5,"cod":5.5,"tilapia fillets":5.5,"tilapia":5.5,"hamburger":5.5,
                 "meatballs":5.5,"frozen meatballs":5.5,"swedish meatballs":5.5,"frozen waffles":5.5,
                 "baby puree":1.5,"good bagels":99,"greek yogurt":5.0,"probiotic yogurt":5.0,
                 "cooking spray":4.0,"lobster":5.5,"spaghetti sauce":4.5,"pasta sauce":4.5,}
...
def organize_grocery_list(grocery_list, dictval):
    ...
    for item in grocery_list:
        try:
            sorted_grocery_list.append((grocery_dict[item],
                                        str(grocery_dict[item]) + " -- " + item))
        except KeyError:
            sorted_grocery_list.append((0, '?'+item))
